...
T.post( 'media/upload', { media_data: b64content }, function ( err, data, response ) {
  ...
  T.post('media/metadata/create', meta_params, function (err, data, response) {
     if (!err) {
         if(rarity1 > 25 ){
          var params = { status: `ayayayayayayayayayayayayayayayaya` , media_ids: [mediaIdStr]  }
          ...
          var params = { status: `Get Rammed` , media_ids: [mediaIdStr]  }
             T.post( 'statuses/update', params , function( err, data, response) {
               if (err){
               console.log( 'error:', err );
               }
          ...
          var params = { status: `Mother Fucker` , media_ids: [mediaIdStr] }
             T.post( 'statuses/update', params , function( err, data, response) {
               if (err){
               console.log( 'error:', err );
               }
          ...
          var params = { status: ` P-chan will be missed` , media_ids: [mediaIdStr] }
             T.post( 'statuses/update', params , function( err, data, response) {
               if (err){
               console.log( 'error:', err );
               }
          ...
          var params = { status: `The H-cup Fighter has appeared` , media_ids: [mediaIdStr] }
             T.post( 'statuses/update', params , function( err, data, response) {
               if (err){
               console.log( 'error:', err );
               }
