  ...
  const posts = new Promise((res,rej) => {
    T.post("media/upload",{media_data: b64content}, function (err, data, response) {
     mediaArray.push(data.media_id_string)
      ...
      console.log(rarity)
      console.log( 'picking a random common...' );
...
}).then(() => {console.log('dissapointment') 
var mediaIdStr = mediaArray.join(",")
var altText = "Ram Me Harder"
var meta_params = { media_id: [mediaArray] , alt_text: { text: altText } }
        return new Promise((res,rej) => {
